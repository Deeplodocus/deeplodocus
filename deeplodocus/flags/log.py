...
from deeplodocus.flags.ext import DEEP_EXT_CSV, DEEP_EXT_LOG
from deeplodocus.utils import get_main_path

DEEP_LOG_NOTIFICATION = Flag(
    name="Notification",
    description="Log : Notification",
    names=["notif", "notification"]
)
...
DEEP_LOGS = {
    DEEP_LOG_NOTIFICATION: [get_main_path(), DEEP_EXT_LOG],
